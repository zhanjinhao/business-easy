...
import cn.addenda.businesseasy.result.EnableServiceResultConverter;
...
public class MultiDataSourceDeclareConfiguration implements EmbeddedValueResolverAware {
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("cn.addenda.businesseasy.result.mapper");
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(new ClassPathResource("cn/addenda/businesseasy/result/TxTestMapper.xml"));
