...
import cn.addenda.businesseasy.jdbc.interceptor.sqlcheck.SQLCheckInterceptor;
...
public class SQLCheckConfiguration implements EmbeddedValueResolverAware {
    ...
    public DataSource dataSource() {
        ...
        filterList.add(new SQLCheckInterceptor());
