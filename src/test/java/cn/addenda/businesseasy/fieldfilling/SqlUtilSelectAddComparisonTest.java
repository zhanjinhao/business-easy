 ...
 * @Date 2022/2/3 11:52
 */
public class SqlUtilSelectAddComparisonTest {
...
//        test1();
    ...
    public static void test1() {
        for (int i = 0; i < sqls.length; i++) {
            ...
            tableNameSet.add("T_DISPATCH_FLIGHT_RELEASE");
            tableNameSet.add("SCORE");
            tableNameSet.add("RELEASE");
            tableNameSet.add("ts_role");
            tableNameSet.add("STUDENT");
            tableNameSet.add("dual");
            tableNameSet.add("t1");
            tableNameSet.add("A");
            tableNameSet.add("tab2");
            tableNameSet.add("tab3");
            tableNameSet.add("tab4");
            tableNameSet.add("table_listnames");

            System.out.println(SqlUtil.selectAddComparison(sqls[i], null, tableNameSet));
        }
    }

    public static void test2() {
        for (int i = 0; i < sqls.length; i++) {
            String s = SqlUtil.selectAddComparison(sqls[i], null);
